...
2. 온라인/대규모 강의에서 학습한 것을 소규모 그룹별 토론하는 과정을 통해 구체적으로 적용할 수 있도록 하며, 강의에서 이해하기 어려웠거나 부족한 부분을 의견교환을 통해 깊이 사고하고 응용할 수 있는 능력을 기를 수 있다.
3. 튜토리얼을 준비하고 진행하는 동안 학생들은 해당 주제에 대해 의심하고 증명하고 검토하는 '비판적 사고법'을 습득할 수 있다.
4. 학생이 주어진 문제에 대해 충분히 노력을 기울이지 않는다면 튜토리얼에서 질문/토론을 할 수 없기 때문에, 학생들의 높은 수업준비도를 기대할 수 있다.
5. 교수님과 소수의 학생들과 자신의 의견을 나누고 소통하는 과정을 통해 비대면으로 인한 학습적 무기력감을 해소하고 학습의 즐거움을 얻을 수 있다.
6. 교수님들은 학생들이 전공 지식을 어느정도로 이해하였는지 쉽게 확인할 수 있음에 따라 강의 난이도를 조절할 수 있다.
7. 궁극적으로 경북대학교 첨성인의 융합 및 탐색적 역량을 강화시킴으로써 새로운 지식가치를 창출하고 근원을 탐구하며 진리에 이를 수 있음을 목표로 한다.
